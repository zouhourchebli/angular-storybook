...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@ngrx/store'),exports, require('tslib'), require('@angular/core'), require('rxjs'), require('@ngrx/store'), require('@angular/core/testing')) :
    typeof define === 'function' && define.amd ? define('@ngrx/store/testing', ['@angular/core','@ngrx/store','exports', 'tslib', '@angular/core', 'rxjs', '@ngrx/store', '@angular/core/testing'], factory) :
    (global = global || self, factory(global.ng.core,global.ngrx.store,(global.ngrx = global.ngrx || {}, global.ngrx.store = global.ngrx.store || {}, global.ngrx.store.testing = {}), global.tslib, global.ng.core, global.rxjs, global.ngrx.store, global.ng.core.testing));
}(this, (function (ɵngcc0,ɵngcc1,exports, tslib, core, rxjs, store, testing) { 'use strict';
    ...
    var MockState = /** @class */ (function (_super) {
        ...
        MockState = tslib.__decorate([ tslib.__metadata("design:paramtypes", [])
        ], MockState);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MockState, [{
    ...
    var MockStore = /** @class */ (function (_super) {
        ...
        MockStore = tslib.__decorate([ tslib.__param(3, core.Inject(store.INITIAL_STATE)),
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MockStore, [{
    ...
    var MockReducerManager = /** @class */ (function (_super) {
        ...
        MockReducerManager = tslib.__decorate([ tslib.__metadata("design:paramtypes", [])
        ], MockReducerManager);
